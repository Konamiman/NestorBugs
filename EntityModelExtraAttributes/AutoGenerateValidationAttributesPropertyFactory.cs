...
namespace Konamiman.VsExtensions.EntityModelExtraAttributes
{
    ...
    class AutoGenerateValidationAttributesPropertyFactory : IEntityDesignerExtendedProperty
    {
        /// <summary>
        ...
        {
            return new AutoGenerateValidationAttributesProperty(element, context);
        }
    }
}